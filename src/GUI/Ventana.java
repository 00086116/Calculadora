    ...
    public Ventana() {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                AF l;
                l = Producer.getFactory("Aritmetica");
        ...
        button2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                Integer valor1 = 0, valor2 = 0, resultado = 0;
                String numero1 = textF1.getText(), n2 = textF3.getText();
        ...
        button5.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                AF l;
                l = Producer.getFactory("Conversion");
                Convertor bin = l.getConvertor("Binario");
                
                int c =0;
                String numero1 = textF1.getText();
                
                c = Integer.parseInt(numero1);

                textF2.setText(bin.Convertir(c));
            }
        });
